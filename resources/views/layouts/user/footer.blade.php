        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                <div>
                    ...
                    <p class="text-gray-400 mb-4">Chuyên cung cấp các sản phẩm giường ngủ và nội thất phòng ngủ chất lượng cao với giá cả hợp lý.</p>
                    <div class="flex space-x-4">
                        <a href="#" class="w-10 h-10 flex items-center justify-center rounded-full bg-gray-800 hover:bg-primary transition">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-white transition">Lịch sử đơn hàng</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition">Danh sách yêu thích</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition">Thông báo</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition">Trung tâm hỗ trợ</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li class="flex">
                            ...
                            <span class="text-gray-400">123 Đường Lê Lợi, Quận 1, TP.Đà Nẵng</span>
                        </li>
                        <li class="flex">
                            <div class="w-5 h-5 flex items-center justify-center text-primary mr-3">
